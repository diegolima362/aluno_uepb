...
List<Course> parseCourses(Document document) {
  ...
  for (final row in rows) {
    ...
    courses.add(
      Course(
        code: codeTitle.first.trim(),
        name: codeTitle.last.trim(),
        professors: [],
...
Map<String, (List<String>, List<Lesson>)> parseScheduleAndProfessor(
  Document document,
) {
  final map = <String, (List<String>, List<Lesson>)>{};
...
List<Lesson> _extractSchedule(Element element) {
...
List<HistoryEntry> parseHistory(Document document) {
