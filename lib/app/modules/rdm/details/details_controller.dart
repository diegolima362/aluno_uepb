...
abstract class _DetailsControllerBase with Store {
  ...
  @observable
  ObservableList<bool> selectedDays;
  ...
  _DetailsControllerBase() {
    ...
    selectedDays = ObservableList<bool>();

    selectedDays.addAll(List.filled(7, false));
  ...
  Future<void> loadData() async {
    ...
    reminders = ObservableList<NotificationModel>();
  ...
  Future<void> showScheduler() async {
    await Modular.to.push(MaterialPageRoute(
      builder: (_) => SchedulerPage(controller: this),
    ));
  }
}
